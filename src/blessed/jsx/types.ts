...
import { BigText, BigTextOptions, Box, BoxOptions, Button, ButtonOptions, CheckboxOptions, Element, FileManager, FileManagerOptions, Form, FormOptions, IKeyEventArg, IMouseEventArg, INodeGenericEventArg, Layout, LayoutOptions, Line, LineOptions, List, ListBar, ListbarOptions, ListOptions, ListTable, ListTableOptions, Node, NodeGenericEventType, NodeMouseEventType, NodeWithEvents, RadioButton, RadioButtonOptions, RadioSet, RadioSetOptions, Text, Textarea, TextareaOptions, Textbox, TextboxOptions, TextOptions } from '../blessedTypes';
...
export interface ArtificialEventOptions<T extends Element> {
  ...
  [ArtificialEventOptionNames.onKeyPress]?: (this: T, e: {
    ch: string;
    key: IKeyEventArg;
  } & ArtificialEvent<T>) => void;
  [ArtificialEventOptionNames.onRender]?: (this: T, e: INodeGenericEventArg & ArtificialEvent<T>) => void;
  [ArtificialEventOptionNames.onChange]?: <V = any>(this: T, e: ArtificialEvent<T> & {
    value: V;
  }) => void;
}
