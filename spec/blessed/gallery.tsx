...
function Div(props: { children?: any }) {
  return (
    <layout renderer={renderer} width="90%" height="90%">
      {props.children}
    </layout>
  )
}
      ...
      <Div>
        ...
        <layout width={20} height={10} border="line" layout="inline">
          ...
          <box
            ...
            content="B"
          />{' '}
          should be displayed like CSS display: inline
        </layout>
        <layout width={20} height={10} border="line" layout="inline-block">
          ...
          <box
            ...
            content="B"
          />{' '}
          should be displayed like CSS display: inline-block
        </layout>
        <Br />
        ...
        <layout width={50} height={20} border="line" layout="grid">
          {new Array(10).fill(0).map((e, i) => (
            <box
              width={Math.random() > 0.5 ? 5 : 10}
              height={Math.random() > 0.5 ? 3 : 7}
              style={{ bg: color() }}
              border="line"
              content={i + 1 + 12 + ''}
            />
