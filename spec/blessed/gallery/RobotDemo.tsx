  ...
  render() {
    return (
      <Div>
        ...
        {/* <layout> */}
          <layout {...{top: 0, left: 0, width: '40%', height: '100%', label: 'Robot Performances', style: {fg: colors.brightcyan, bg: colors.lightgreen}}}>
          <Br />
        ...
        /> */}
          ...
          <Button top={13} left={1} onClick={e=>this.moveMouseChangePointer()}>move mouse, change pointer</Button>>

          </layout>

          <layout  {...{top: 0, left: '40%', width: '55%', height: '100%', label: 'here!', style: {fg: colors.brightblack, bg: colors.lightblue,}}}>


          Playing with Low level API to automate the terminal, will I be able to do it?, me ? , being so so high level JSX / React / Web light developer ? Ho no the PC has broken, call the IT guy!!
        <Br />{}
...
enum performs {'move mouse, change pointer'}