...
export class LayoutDemo extends Component {
  render() {
    return (<Div>
      TIP: Press [2] to re render this example and see how sizes that are random affect the layouts.<Br />
      ...
      <layout width={number(15, 20)} height={number(6, 13)} border="line" layout="inline">
        Just some text with a bigger box
          <box height={3} width={3} border="line" style={{ fg: 'blue', bold: true, border: { fg: 'magenta' } }} content="B" />
      ...
      <layout width={number(40, 60)} height={number(15, 20)} border="line" layout="grid">
        {new Array(10).fill(0).map((e, i) => (<box width={number(5, 10)} height={number(4, 7)} style={{ bg: color() }} border="line" content={i + 1 + 12 + ''} />))}
      </layout>
    </Div>);
  }
}
